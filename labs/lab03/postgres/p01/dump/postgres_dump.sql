...
CREATE DATABASE snet WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C';

CREATE USER socialnet PASSWORD 'socialnet';;
GRANT ALL PRIVILEGES ON DATABASE snet TO socialnet;

ALTER DATABASE snet OWNER TO postgres;
