...
echo test sending meddage using cassandra
...
echo test sending meddage using postgres
curl -i -X POST http://localhost:8802/dialog/628ad2a9-1676-5aba-f27c-dd38363128b8/send  -H "Authorization: Bearer OGJHGZ76N654Z33JYKW65CY3NU" -d '{"text":"message1 From Anna to Katya"}'
